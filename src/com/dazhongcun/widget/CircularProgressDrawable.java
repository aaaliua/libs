...
public class CircularProgressDrawable extends Drawable implements Animatable {
	...
	private   int ANGLE_ANIMATOR_DURATION = 2000;
	private   int SWEEP_ANIMATOR_DURATION = 800;
	...
	public CircularProgressDrawable(int color, float borderWidth,int angel,int sweep) {
		mBorderWidth = borderWidth;
		...
		mPaint.setStrokeWidth(borderWidth);
		mPaint.setColor(color);
		ANGLE_ANIMATOR_DURATION = angel;   //设置外圈动画时间
		SWEEP_ANIMATOR_DURATION = sweep;   
		setupAnimations();
	}
	...
	private Property<CircularProgressDrawable, Float> mAngleProperty = new Property<CircularProgressDrawable, Float>(
		...
		@Override
		public void set(CircularProgressDrawable object,
				Float value) {
