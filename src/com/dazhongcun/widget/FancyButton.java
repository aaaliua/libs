...
public class FancyButton  extends LinearLayout{
    ...
    private void init(){
            ...
            if(mIconPosition==POSITION_LEFT || mIconPosition==POSITION_TOP){
                ...
                if(isLines == true){
                     ...
                     t.setLayoutParams(new LinearLayout.LayoutParams(1, LinearLayout.LayoutParams.FILL_PARENT));
                     t.setBackgroundResource(R.color.transalt_);
                     views.add(t);
                }
    ...
    private void initAttributs(TypedArray attrsArray){
        ...
        boolean is_lines 				= attrsArray.getBoolean(R.styleable.FancyButtonsAttrs_horizontal_line, false);
