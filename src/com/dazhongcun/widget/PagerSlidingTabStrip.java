...
import com.dazhongcun.utils.ScreenUtils;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	/**
	 * 如果是需要指示器为图标  可是在继承adapter后 实现该接口  
	 * @author Administrator
	 *
	 */
	...
	public void notifyDataSetChanged() {
		...
		if(tabCount <=3){
			isLow = false;
			defaultTabLayoutParams = new LinearLayout.LayoutParams(ScreenUtils.getWidth(getContext()) / tabCount, LayoutParams.MATCH_PARENT);
			expandedTabLayoutParams = new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1.0f);
	...
	private void addTab(final int position, View tab) {
		...
		tab.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				pager.setCurrentItem(position,isAnima);
			}
		});
...
//				tab.setTextColor(getResources().getColor(R.color.text_color_selector));
	...
	public void setTextFocusColor(int textFocusColor) {
		this.tabTextFocusColor = textFocusColor;
		updateTabStyles();
	}
	public void setTextFocusColorResource(int resId) {
		this.tabTextFocusColor = getResources().getColor(resId);
		updateTabStyles();
	}
	//获取焦点字体颜色
	...
	//设置viewpager是否有动画
	public void setViewPagerAnimation(boolean b){
		this.isAnima = b;
	}
