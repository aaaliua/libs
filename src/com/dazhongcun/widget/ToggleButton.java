...
public class ToggleButton extends View{
	...
	/** 开启颜色*/
	private int onColor = /*Color.parseColor("#fe5d7c");*/getResources().getColor(R.color.merchants_color);
	/** 关闭颜色*/
	...
	public void setup(AttributeSet attrs) {
		...
		borderWidth = typedArray.getDimensionPixelSize(R.styleable.ToggleButton_tog_borderWidth, borderWidth);
		typedArray.recycle();
	}
